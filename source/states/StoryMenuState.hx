...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 225).loadGraphic(Paths.image('Menu_Tracks'));
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		txtWeekTitle.x = FlxG.width - (txtWeekTitle.width + 430);
